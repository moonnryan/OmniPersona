            ...
            do {
                for try await inputBuffer in stream {
                    guard inputBuffer.frameLength > 0,
                          inputBuffer.audioBufferList.pointee.mBuffers.mDataByteSize > 0
                    else {
                        continue
                    }
                ...
                for trailingBuffer in trailingBuffers {
                    guard trailingBuffer.frameLength > 0,
                          trailingBuffer.audioBufferList.pointee.mBuffers.mDataByteSize > 0
                    else {
                        continue
                    }
